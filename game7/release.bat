...
set compile_flags=/std:c++20 /MP /MT /Zi /O2 /diagnostics:color /diagnostics:caret
...
cl %compile_flags% %includes% ..\src\main.cpp %libs% %windows_libs% /Fegame7.exe /link %link_flags%
