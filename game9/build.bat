...
set compile_flags=/std:c++20 /MP /MT /Zi /Od /diagnostics:color /diagnostics:caret /D"DEBUG=1" /wd4530
...
cl %compile_flags% %includes% ..\src\main.cpp %libs% %windows_libs% /Fegame9.exe /link %link_flags%
