...
set compile_flags=/std:c++20 /MP /MT /O2 /diagnostics:color /diagnostics:caret /wd4530
set link_flags=/SUBSYSTEM:CONSOLE /INCREMENTAL
...
cl %compile_flags% %includes% ..\src\main.cpp %libs% %windows_libs% /Fegame8.exe /link %link_flags%
